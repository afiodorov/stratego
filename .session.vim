...
inoremap <silent> <SNR>90_AutoPairsReturn =AutoPairsReturn()
...
nnoremap ,r :TernRename
nnoremap ,K :TernDocBrowse
nmap ,ihn :IHN
nmap ,is :IHS:A
nmap ,ih :IHS
...
nnoremap <silent> ,p :call append(line('.'), substitute(@+, '\n$', '', ''))
nnoremap ,ep :profile pause:noautocmd qall!
nnoremap ,sp :profile start profile.log:profile func *:profile file *
nnoremap ,cd :cd %:p:h
map ,lc :GundoToggle
...
nnoremap ,mr :cd %:p:h/..:make -j4
nnoremap ,md :cd %:p:h/..:make debug -j4
nnoremap ,sr :TernRefs
nnoremap ,/ :call EscapeBuffer()/\vi
nnoremap <silent> ,hl :match OverLength /\%81v.\+/
nnoremap ,w :update
nnoremap ,sm :%s///g
nnoremap ,ej :vsplit ~/.vim/ftplugin/java.vim
nnoremap ,sj :source ~/.vim/ftplugin/java.vim
nnoremap ,sl :source ~/.vim/ftplugin/tex.vim
...
map <silent> <expr> <Plug>(easymotion-clever-sn) EasyMotion#is_active() ? '<Plug>(easymotion-next)' : '<Plug>(easymotion-sn)'
map <silent> <expr> <Plug>(easymotion-clever-s2) EasyMotion#is_active() ? '<Plug>(easymotion-next)' : '<Plug>(easymotion-s2)'
map <silent> <expr> <Plug>(easymotion-clever-s) EasyMotion#is_active() ? '<Plug>(easymotion-next)' : '<Plug>(easymotion-s)'
...
set shortmess=aoO
badd +1 test/test.js
badd +9 public/utils/gameStructs.js
badd +72 public/utils/gameLogic.js
badd +16 ~/.vimrc
args test/test.js
edit public/utils/gameStructs.js
...
exe '1resize ' . ((&lines * 3 + 37) / 74)
exe '2resize ' . ((&lines * 68 + 37) / 74)
argglobal
enew
let s:cpo_save=&cpo
set cpo&vim
...
setlocal tabstop=2
setlocal tags=~/cplus/stratego/.git/javascript.tags,~/cplus/stratego/.git/tags,./tags;/
setlocal textwidth=0
setlocal thesaurus=
setlocal noundofile
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 72 - ((0 * winheight(0) + 34) / 68)
